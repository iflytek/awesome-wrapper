...
#### 创建start.sh
````
 sudo docker run --name findergo-test -v /opt/finder:/root/go/src/git.iflytek.com/AIaaS/finder-go/v3/bin 172.16.59.153/aiaas/findergo-demo:2.0.0 ./demo /root/go/src/git.iflytek.com/AIaaS/finder-go/v3/bin/conf.json
...
start2.sh
````
sudo docker run --name findergo-test1 -v /opt/finder:/root/go/src/git.iflytek.com/AIaaS/finder-go/v3/bin 172.16.59.153/aiaas/findergo-demo:2.0.0 ./demo /root/go/src/git.iflytek.com/AIaaS/finder-go/v3/bin/conf1.json
````
